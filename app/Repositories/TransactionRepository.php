...
class TransactionRepository implements TransactionRepositoryInterface
{
    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            // set to deployment/sandbox environment (default). set to true for production environment (accept real transaction).
            \Midtrans\Config::$isProduction = config('midtrans.isProduction');
            // set sanitation on (default)
    ...
    private function calculateShippingAndTax(array $data, float $subtotal, int $weight): array
    {
        ...
        $response = Http::asForm()->withHeaders([
            ...
            'weight' => $weight,
            'courier' => 'jne:sicepat:ide:sap:jnt:ninja:tiki:lion:anteraja:pos:ncs:rex:rpx:sentral:star:wahan:dse',
            'price' => 'lowest'
        ]);
