...
class StoreBalanceHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Riwayat Dompet Toko berhasil di ambil', StoreBalanceHistoryResource::collection($storeBalanceHistories), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Riwayat Dompet Toko berhasil di ambil', PaginateResource::make($storeBalanceHistories, StoreBalanceHistoryResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
