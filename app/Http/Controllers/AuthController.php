...
class AuthController extends Controller
{
    ...
    public function register(RegisterStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Registrasi Berhasil', new UserResource($user), 201);
        } catch (Exception $e) {
    ...
    public function login(LoginStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Login Berhasil', new UserResource($user), 201);
        } catch (Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
