...
class BuyerController extends Controller
{
    ...
    {
        try {
            $users = $this->buyerRepository->getAll(
                $request->search,
                $request->limit,
                true
            );

            return ResponseHelper::jsonResponse(true, 'Data Pembeli Berhasil Diambil', BuyerResource::collection($users), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data User berhasil di ambil', PaginateResource::make($buyers, BuyerResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            if (!$buyer) {
                return ResponseHelper::jsonResponse(false, 'Data Pembeli Tidak Ditemukan', null, 404);
            }
